    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      {user && (
        <header className="bg-white border-b-2 border-blue-600 sticky top-0 z-50 px-4 py-3 flex items-center justify-between shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <div className="bg-blue-600 p-2 rounded-lg text-white shadow-md shadow-blue-100 transition-transform hover:scale-105 cursor-default">
          ...
          <div className="flex items-center gap-3 md:gap-5">
            <div className="flex flex-col items-end leading-tight text-right">
              <span className="text-[8px] md:text-[9px] font-black text-slate-400 uppercase tracking-[0.2em] mb-0.5">
                lead lecturer:
              </span>
              <span className="font-black text-blue-700 text-xs md:text-sm uppercase tracking-tight">
                {user.name}
              </span>
            </div>
            ...
            <div className="flex items-center">
              <button 
                ...
                className="w-10 h-10 md:w-11 md:h-11 flex items-center justify-center bg-red-50 text-red-500 rounded-xl hover:bg-red-500 hover:text-white transition-all border border-red-100 shadow-sm group active:scale-95"
      ...
      {showLogoutConfirm && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          {/* Modal Content Card */}
          <div className="relative bg-white w-full max-w-sm rounded-[40px] shadow-2xl overflow-hidden animate-in zoom-in-95 fade-in duration-200">
            <div className="p-8 md:p-10">
              ...
              <div className="flex flex-col gap-3">
                <button 
                  ...
                  className="w-full bg-red-600 hover:bg-red-700 text-white font-black py-4.5 rounded-2xl shadow-xl shadow-red-100 transition-all active:scale-95 flex items-center justify-center gap-2"
                >
                  <LogOut size={18} />
                  YES, LOGOUT
                </button>
                <button 
                  onClick={() => setShowLogoutConfirm(false)}
                  className="w-full bg-slate-100 hover:bg-slate-200 text-slate-600 font-black py-4.5 rounded-2xl transition-all active:scale-95"
                >
                  STAY CONNECTED
                </button>
              </div>
      ...
      <footer className="mt-auto px-6 py-12 bg-white border-t border-slate-100 flex flex-col items-center">
        ...
        <div className="text-center space-y-3 mb-10">
          <h3 className="text-blue-900 font-black text-sm tracking-widest uppercase px-6 leading-relaxed max-w-md">
